package com.example.fullstackmedspringboot.controllers;

import com.example.fullstackmedspringboot.services.MovieService;
...
public class MovieController {
    ...
    @PostMapping("/insert")
    public String insert(@RequestParam String title, @RequestParam int releaseYear, @RequestParam String description,
    ...
    @PostMapping("/update")
    public String update(@RequestParam int id, @RequestParam String title, @RequestParam int releaseYear, @RequestParam String description,
                         @RequestParam String tags) {

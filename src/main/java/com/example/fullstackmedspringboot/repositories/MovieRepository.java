package com.example.fullstackmedspringboot.repositories;

import com.example.fullstackmedspringboot.models.Movie;
...
public class MovieRepository {
    ...
    public void insert(String title, int releaseYear, String description, String tags) {
        String query = "INSERT INTO movie(title, release_year, description, tags)" + "VALUES (?, ?, ?, ?);";
